...
import at.dhinterndorfer.faktura.sale.article.SaleArticleMapper;
...
@Mapper(uses = {NullableMapper.class, OperatorTupleMapper.class, SaleServiceMapper.class, SaleArticleMapper.class})
