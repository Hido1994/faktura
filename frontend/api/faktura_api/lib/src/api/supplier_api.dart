...
class SupplierApi {
  ...
  Future<Response<void>> deleteSupplier({
    required int id,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Supplier>> getSupplierById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<SupplierPage>> getSuppliers({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SupplierPage),
            ) as SupplierPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Supplier] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Supplier>> saveSupplier({
    ...
    try {
      const _type = FullType(Supplier);
      _bodyData = _serializers.serialize(supplier, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
