...
import 'package:faktura_api/src/model/account_filter_request.dart';
...
class AccountApi {
  ...
  Future<Response<void>> deleteAccount({
    ...
    final _path = r'/account/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Account>> getAccountById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AccountPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AccountPage>> getAccounts({
    ...
    try {
      const _type = FullType(AccountFilterRequest);
      _bodyData = accountFilterRequest == null
          ? null
          : _serializers.serialize(accountFilterRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AccountPage),
            ) as AccountPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Account] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Account>> saveAccount({
