...
class PaymentMethodApi {
  ...
  Future<Response<void>> deletePaymentMethod({
    ...
    final _path = r'/paymentMethod/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentMethod>> getPaymentMethodById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentMethod] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentMethod>> savePaymentMethod({
    ...
    try {
      const _type = FullType(PaymentMethod);
      _bodyData = _serializers.serialize(paymentMethod, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
