...
class CustomerApi {
  ...
  Future<Response<void>> deleteCustomer({
    required int id,
    ...
    final _path = r'/customer/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Customer>> getCustomerById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CustomerPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomerPage>> getCustomers({
    Pageable? pageable,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CustomerPage),
            ) as CustomerPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Customer] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Customer>> saveCustomer({
