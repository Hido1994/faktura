...
class SettingApi {
  ...
  const SettingApi(this._dio, this._serializers);
  ...
  Future<Response<void>> deleteSetting({
    ...
    final _path = r'/setting/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Setting>> getSettingById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<SettingPage>> getSettings({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(SettingPage),
            ) as SettingPage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Setting] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Setting>> saveSetting({
