...
class FileApi {
  ...
  Future<Response<void>> deleteFile({
    ...
    final _path = r'/file/{id}'.replaceAll('{' r'id' '}',
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<File>> getFileById({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FilePage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FilePage>> getFiles({
    Pageable? pageable,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(FilePage),
            ) as FilePage;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<File>> saveFile({
    ...
    try {
      const _type = FullType(File);
      _bodyData = _serializers.serialize(file, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
